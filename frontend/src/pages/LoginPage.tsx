    ...
    >
      <div className="card-central" style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div className="text-center" style={{ marginTop: '20px' }}>
          {tipo === 'cliente' && (
            <p>
              <Link to="/cadastro" className="subtext">
          ...
          {tipo === 'equipe' && (
            <p>
              <Link to="/equipe/cadastro" className="subtext">
                <strong>Criar cadastro da equipe</strong>
              </Link>
            </p>
          )}

          <p>
            <Link to="/esqueci-senha" className="subtext">
              Esqueci minha senha
            </Link>
          </p>
        </div>
